...
# 1. as sidevar menu
with st.sidebar:
    st.markdown("<h1 style='font-size:15px;text-align: center; color: black;'>Aisyatur Radiah_200411100116</h1>", unsafe_allow_html=True)
...
if selected == "Referensi":
    ...
    st.markdown("<h1 style='font-size:15px;text-align: left; color: black;'>Nama : Aisyatur Radiah</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='font-size:15px;text-align: left; color: black;'>Nim : 200411100116</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='font-size:15px;text-align: left; color: black;'>Mata Kuliah : Penambangan Data- A</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='font-size:15px;text-align: left; color: black;'>Dosen Pengampu : Mula'ab, S.Si., M.Kom.</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='font-size:15px;text-align: left; color: black;'>Breast Cancer Prediction Dataset</h1>", unsafe_allow_html=True)

    st.title (f"Link Aplikasi Project")
    st.subheader("""Github Project UAS""")
    st.write("""
    Sumber data di dapatkan melalui website kaggle.com, Berikut merupakan link untuk mengakses sumber dataset.
    <a href="https://github.com/aisyaturradiah/breast_cancer">github project</a>""", unsafe_allow_html=True)

    st.subheader("""Github untuk web statis""")
    st.write("""
    Sumber data di dapatkan melalui website kaggle.com, Berikut merupakan link untuk mengakses sumber dataset.
    <a href="https://aisyaturradiah.github.io/datamining/intro.html">github materi</a>""", unsafe_allow_html=True)
