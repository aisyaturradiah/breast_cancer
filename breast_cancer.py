...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Beranda", "Description", "Dataset", "Preprocessing", "Modelling", "Implementation"], #required
        icons=["house-door-fill", "book-half", "bi bi-file-earmark-arrow-up-fill", "arrow-repeat","medium", "folder-fill"], #optional
        menu_icon="cast", #optional
        default_index=0, #optional
    styles={
        "container": {"padding": "0!important", "background-color":"white"},
        "icon": {"color": "dark turquoise", "font-size": "19px"},
        "nav-link": {
            "font-size": "19px",
            "text-align": "left",
            "margin": "2px",
...
<div class="footer">
    <span>Copyright &copy; 2022 by <a href="mailto: aisyaturradiah123@gmail.com">Aisyatur Radiah</a> All Right Reserved</span>
</div>
"""
